  ...
  $.ContextControls.prototype = {
    ...
    manipulationTemplate: $.Handlebars.compile([
                                ...
                                '{{#if filtersSupported}}',
                                   ...
                                   '<div class="mirador-osd-brightness-slider mirador-slider"></div>',
                                   '</a>',
                                   '{{/if}}',
                                   '{{#if showContrast}}',
                                   ...
                                   '<i class="fa fa-caret-down"></i>',
                                   '<div class="mirador-osd-contrast-slider mirador-slider"></div>',
                                   '</a>',
                                   '{{/if}}',
                                   '{{#if showSaturate}}',
                                   ...
                                   '<i class="fa fa-caret-down"></i>',
                                   '<div class="mirador-osd-saturation-slider mirador-slider"></div>',
                                   '</a>',
                                   '{{/if}}',
                                   '{{#if showGrayscale}}',
